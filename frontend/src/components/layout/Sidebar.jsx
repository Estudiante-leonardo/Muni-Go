      ...
      >
        ...
        <nav className="space-y-2">
          <Link
            to="/"
            onClick={() => setIsMenuOpen(false)}
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-semibold flex items-center cursor-pointer transition-all ${isDashboard
          ...
          <Link
            to="/tramites"
            onClick={() => setIsMenuOpen(false)}
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-semibold flex items-center cursor-pointer transition-all ${isCatalog && location.pathname === '/tramites'
              ? 'bg-blue-50 text-blue-700 dark:bg-blue-950/20 dark:text-blue-400'
              : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/40'
              }`}
          >
